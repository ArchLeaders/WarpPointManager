...
using WarpPointManager.ViewResources.Helpers;
...
namespace WarpPointManager.ViewModels
{
    public class ShellViewModel : Screen
    {
        ...
        public string HelpLink { get; set; } = "https://github.com/ArchLeaders/WarpPointManager";
        public string Title { get; set; } = "Warp Point Manager";

        // Error report settings
        public static bool UseGitHubUpload { get; set; } = false;
        public string GitHubRepo { get; set; } = "WarpPointManager";
